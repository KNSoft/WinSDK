...
// All wwan drivers which version is greater than 2.169 are using mbbcx, so all new OIDs and notifications added after 2.169 doesn't need specific revision anymore.
// NDIS_WWAN_GENERAL_REVISION_1 is created for all new OIDs and notifications added after 2.168
#define NDIS_WWAN_GENERAL_REVISION_1 1
...
#define SIZEOF_NDIS_WWAN_SET_PROVISIONED_CONTEXT_REVISION_2_FOR_NON_MBBCX_DRIVER \
    (FIELD_OFFSET(NDIS_WWAN_SET_PROVISIONED_CONTEXT_V2, ProvisionedContext) + RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_PROVISIONED_CONTEXT_V2, Reserved))
#endif
...
#if (NTDDI_VERSION >= NTDDI_WIN8 || NDIS_SUPPORT_NDIS630)
#define SIZEOF_WWAN_SET_CONTEXT_STATE_REVISION_1 (RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, AuthType))
#define SIZEOF_NDIS_WWAN_SET_CONTEXT_STATE_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_SET_CONTEXT_STATE, SetContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, AuthType))
#define SIZEOF_WWAN_SET_CONTEXT_STATE_REVISION_2 (RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, IPType))
#define SIZEOF_NDIS_WWAN_SET_CONTEXT_STATE_REVISION_2 \
    (FIELD_OFFSET(NDIS_WWAN_SET_CONTEXT_STATE, SetContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, IPType))
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS1 || NDIS_SUPPORT_NDIS660)
#define SIZEOF_WWAN_SET_CONTEXT_STATE_REVISION_3 (RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, ConnectionMediaSource))
#define SIZEOF_NDIS_WWAN_SET_CONTEXT_STATE_REVISION_3 \
    (FIELD_OFFSET(NDIS_WWAN_SET_CONTEXT_STATE, SetContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_CONTEXT_STATE, ConnectionMediaSource))
#endif
...
#define MIN_SIZEOF_NDIS_WWAN_SET_CONTEXT_STATE_REVISION_4 \
    (FIELD_OFFSET(NDIS_WWAN_SET_CONTEXT_STATE, SetContextState) + MIN_SIZEOF_WWAN_SET_CONTEXT_STATE_REVISION_4)
#endif

#define NDIS_WWAN_SET_SMS_CONFIGURATION_REVISION_1 1
#if (NTDDI_VERSION >= NTDDI_WIN10_FE)
#define NDIS_WWAN_SET_SMS_CONFIGURATION_REVISION_2 2
#endif
...
#define SIZEOF_NDIS_WWAN_MBIM_VERSION_1 \
    (FIELD_OFFSET(NDIS_WWAN_MBIM_VERSION, MbimVersion) + RTL_SIZEOF_THROUGH_FIELD(WWAN_MBIM_VERSION, MbimVersion))
...
#define NDIS_WWAN_BASE_STATIONS_INFO_REQ_REVISION_2 2
#endif // (NTDDI_VERSION >= NTDDI_WIN10_MN || NDIS_SUPPORT_NDIS684)

#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_REQ_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO_REQ, BaseStationsInfoRequest) + RTL_SIZEOF_THROUGH_FIELD(WWAN_BASE_STATIONS_INFO_REQ, MaxCDMACount))
#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_REQ_REVISION_2 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO_REQ, BaseStationsInfoRequest) + RTL_SIZEOF_THROUGH_FIELD(WWAN_BASE_STATIONS_INFO_REQ, MaxNRCount))

#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_RESULT_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO, BaseStationsInfo.CDMAMrlSize) - FIELD_SIZE(NDIS_WWAN_BASE_STATIONS_INFO, BaseStationsInfo.SystemSubType))
#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_RESULT_REVISION_2 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO, BaseStationsInfo.BaseStationsData))
...
#if (NTDDI_VERSION >= NTDDI_WIN10_VB || NDIS_SUPPORT_NDIS684)
// NDIS_WWAN_DEVICE_CAPS_EX_REVISION_2 was for the Vibranium version of internal 5G SA development,
// which never turns into official support for 5G SA in Vibranium. 
// In Manganese/Iron, DEVICE_CAPS_EX is updated and the corresponding NDIS_WWAN_DEVICE_CAPS_EX_REVISION_3 introduced.
// Except for inbox Microsoft components of Vibranium version, NDIS_WWAN_DEVICE_CAPS_EX_REVISION_2 is not used anywhere. 
#define NDIS_WWAN_DEVICE_CAPS_EX_REVISION_2 2
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_MN || NDIS_SUPPORT_NDIS684)
#define NDIS_WWAN_DEVICE_CAPS_EX_REVISION_3 3
#endif
...
#define SIZEOF_NDIS_WWAN_CONTEXT_STATE_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_CONTEXT_STATE, ContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_CONTEXT_STATE, VoiceCallState))
#define SIZEOF_NDIS_WWAN_CONTEXT_STATE_REVISION_2 \
    (FIELD_OFFSET(NDIS_WWAN_CONTEXT_STATE, ContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_CONTEXT_STATE, IPType))
#define SIZEOF_NDIS_WWAN_CONTEXT_STATE_REVISION_3 \
    (FIELD_OFFSET(NDIS_WWAN_CONTEXT_STATE, ContextState) + RTL_SIZEOF_THROUGH_FIELD(WWAN_CONTEXT_STATE, ConnectionMedia))
...
#if (NTDDI_VERSION >= NTDDI_WIN10_FE)
#define NDIS_WWAN_SMS_CONFIGURATION_REVISION_2 2
#endif
...
#define NDIS_WWAN_LTE_ATTACH_STATUS_REVISION_2 2
...
#endif // (NTDDI_VERSION >= NTDDI_WIN10_RS3 || NDIS_SUPPORT_NDIS680)
#if (NTDDI_VERSION >= NTDDI_WIN10_MN || NDIS_SUPPORT_NDIS684)
#define NDIS_WWAN_BASE_STATIONS_INFO_REVISION_2 2
#endif // (NTDDI_VERSION >= NTDDI_WIN10_MN || NDIS_SUPPORT_NDIS684)
...
#define NDIS_WWAN_QUERY_UICC_TERMINAL_CAPABILITY_REVISION_1 1
...
// data for NDIS_WWAN_STATUS_UE_POLICY_STATE
