...
typedef enum _NETFUNCENUM {
    ...
    NetAdapterOffloadSetLsoCapabilitiesTableIndex = 85,
    NetOffloadIsLsoIPv4EnabledTableIndex = 86,
    NetOffloadIsLsoIPv6EnabledTableIndex = 87,
    NetFunctionTableNumEntries = 88,
} NETFUNCENUM;
