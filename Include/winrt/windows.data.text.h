...
namespace ABI {
    namespace Windows {
        namespace Data {
            namespace Text {
                /* [object, uuid("B84723B8-2C77-486A-900A-A3453EEDC15D"), exclusiveto, contract] */
                MIDL_INTERFACE("B84723B8-2C77-486A-900A-A3453EEDC15D")
                ITextPredictionGenerator2 : public IInspectable
                {
                public:
                    /* [overload] */virtual HRESULT STDMETHODCALLTYPE GetCandidatesWithParametersAsync(
                        /* [in] */__RPC__in HSTRING input,
                        /* [in] */UINT32 maxCandidates,
                        /* [in] */ABI::Windows::Data::Text::TextPredictionOptions predictionOptions,
                        /* [in] */__RPC__in_opt __FIIterable_1_HSTRING * previousStrings,
                        /* [retval, out] */__RPC__deref_out_opt __FIAsyncOperation_1___FIVectorView_1_HSTRING * * result
                        ) = 0;
...
/* [overload] */HRESULT ( STDMETHODCALLTYPE *GetCandidatesWithParametersAsync )(
        __x_ABI_CWindows_CData_CText_CITextPredictionGenerator2 * This,
        /* [in] */__RPC__in HSTRING input,
        /* [in] */UINT32 maxCandidates,
        /* [in] */__x_ABI_CWindows_CData_CText_CTextPredictionOptions predictionOptions,
        /* [in] */__RPC__in_opt __FIIterable_1_HSTRING * previousStrings,
        /* [retval, out] */__RPC__deref_out_opt __FIAsyncOperation_1___FIVectorView_1_HSTRING * * result
        );
