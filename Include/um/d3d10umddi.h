...
#define D3D11DDI_MINOR_HEADER_VERSION 25
#endif
...
#endif
#if D3D11DDI_MINOR_HEADER_VERSION >= 25
    D3DWDDM3_2DDI_RESOURCE_MISC_NO_SHADER_ACCESS             = 0x00080000L,
#endif
...
#endif
#if D3D11DDI_MINOR_HEADER_VERSION >= 23
#define D3DWDDM3_0DDI_FORMAT_SUPPORT_DISPLAYABLE          0x00100000 // format supports displayable
#endif
#if D3D11DDI_MINOR_HEADER_VERSION >= 24
#define D3D11_1DDI_FORMAT_SUPPORT_DISPLAY                 0x00200000 // format supports scanout (separate from displayable)
#endif
...
#if D3D11DDI_MINOR_HEADER_VERSION >= 25
    D3DWDDM3_2DDICAPS_D3D11_OPTIONS6 = 158,
#endif // D3D11DDI_MINOR_HEADER_VERSION >= 25
...
#if D3D11DDI_MINOR_HEADER_VERSION >= 25
typedef enum D3D11DDI_SHADER_ACCESS_RESTRICTED_RESOURCE_TIER
{
    D3D11DDI_SHADER_ACCESS_RESTRICTED_RESOURCE_TIER_0         = 0,
    D3D11DDI_SHADER_ACCESS_RESTRICTED_RESOURCE_TIER_1         = 1,
} D3D11DDI_SHADER_ACCESS_RESTRICTED_RESOURCE_TIER;

typedef struct D3DWDDM3_2DDI_D3D11_OPTIONS6_DATA
{
    D3D11DDI_SHADER_ACCESS_RESTRICTED_RESOURCE_TIER ShaderAccessRestrictedResourceTier;
} D3DWDDM3_2DDI_D3D11_OPTIONS6_DATA;
#endif // D3D11DDI_MINOR_HEADER_VERSION >= 25
...
#if D3D11DDI_MINOR_HEADER_VERSION >= 21
typedef enum D3D11_UMD_MODE
{
    D3D11_UMD_MODE_NATIVE11,     // use OpenAdapter10_2 entrypoint of IHV's UMD
    D3D11_UMD_MODE_SYSTEM11ON12, // use OpenAdapter_D3D11On12 entrypoint of OS d3d11on12.dll
    D3D11_UMD_MODE_VENDOR11ON12  // use OpenAdapter_D3D11On12 entrypoint of IHV's UMD
} D3D11_UMD_MODE;

typedef HRESULT(APIENTRY *PFND3D11DDI_QUERYDESIREDMODE1)(_In_ PFND3DDDI_ESCAPECB, _In_ HANDLE, _Out_ D3D11_UMD_MODE *);
#endif
...
#if D3D11DDI_MINOR_HEADER_VERSION >= 19
#define D3DWDDM3_0_DDI_MINOR_VERSION 43
#define D3DWDDM3_0_DDI_BUILD_VERSION 0


#define D3DWDDM3_0_DDI_INTERFACE_VERSION ((D3D11_DDI_MAJOR_VERSION << 16) | D3DWDDM3_0_DDI_MINOR_VERSION)
#define D3DWDDM3_0_DDI_SUPPORTED ((((UINT64)D3DWDDM3_0_DDI_INTERFACE_VERSION) << 32) | (((UINT64)D3DWDDM3_0_DDI_BUILD_VERSION) << 16))
#endif

#if D3D11DDI_MINOR_HEADER_VERSION >= 20
#define D3DWDDM3_1_DDI_MINOR_VERSION 44
#define D3DWDDM3_1_DDI_BUILD_VERSION 0


#define D3DWDDM3_1_DDI_INTERFACE_VERSION ((D3D11_DDI_MAJOR_VERSION << 16) | D3DWDDM3_1_DDI_MINOR_VERSION)
#define D3DWDDM3_1_DDI_SUPPORTED ((((UINT64)D3DWDDM3_1_DDI_INTERFACE_VERSION) << 32) | (((UINT64)D3DWDDM3_1_DDI_BUILD_VERSION) << 16))
#endif

#if D3D11DDI_MINOR_HEADER_VERSION >= 21
#define D3DWDDM3_2_DDI_MINOR_VERSION 45
#define D3DWDDM3_2_DDI_BUILD_VERSION 1


#define D3DWDDM3_2_DDI_INTERFACE_VERSION ((D3D11_DDI_MAJOR_VERSION << 16) | D3DWDDM3_2_DDI_MINOR_VERSION)
#define D3DWDDM3_2_DDI_SUPPORTED ((((UINT64)D3DWDDM3_2_DDI_INTERFACE_VERSION) << 32) | (((UINT64)D3DWDDM3_2_DDI_BUILD_VERSION) << 16))
#endif
